...
**Figure 7:** Plot bar comparing the abundance of different phylum within the samples of Nursing Students and Regular Students. Positive and negative contorls are also present for comparison. 
...
**Figure 8:** Boxplot showing the Alpha Diversity Measure within types of samples.
...
**Figure 9:** Table summarizing sequence counts for each Phylum.
