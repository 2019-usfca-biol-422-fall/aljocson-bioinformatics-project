...
# Number of sequences that match
melted_phyloseq %>%
...
**Figure 7:** Plot bar comparing the abundance of different phyla within the samples of Nursing Students and Regular Students. Positive and negative contorls are also present for comparison. 
...
**Figure 9:** Plot bar showing the sum Abundance of the different phyla between all Sample Groups: Nursing Students versus Regular students. This also includes all Negative controls. 
...
melted_phyloseq %>%
  ...
  theme(axis.text.x = element_text(angle = 50,
                                   ...
                                   vjust = 1,
                                   size = 4)) +
  geom_text_repel(aes(label = sum_abundance), vjust = -1, size = 3) +
  ggtitle("Sum Abundance of phyla in Sample Groups")
```
**Figure 10:** Bar plot showing the difference between the sum abundance of phyla in Samples groups: Nursing Student versus Regular Student. This does not include any negative control samples. 
...
**Figure 11:** Bar plot showing the difference between the mean abundance of Phyla in Samples groups: Nursing Student versus Regular Student. 
...
**Figure 12:** Boxplot showing the Alpha Diversity Measure within types of samples using Shannon's and Simpson's indexes. Simpson is a similarity index while Shannon is a diversity index. 
...
```
**Figure 13:** Specific samples from either group: Nusing Student (a) and Regular Students (b) that have a "Not Available" phyla type. 
