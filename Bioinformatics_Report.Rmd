...
I also used DADA to analyze my data by running my Illumina sequences through an R pipeline. My DADA results identified 92 bimeras out of 675 input sequences. My data was compiled into a markdown table indicating the amount denoised, sequence table, and non-chimeric reads (Table 7). My amount of nucleotides denoised were also the same number for the sequence table reads for all samples. The non-chimeric reads were for 1A: 7497, 2A: 10309, 3A: 7124, 1B: 13674, 2B: 13831, 3B: 11852. From denoising, I found the sequence variants for each unique sequences with 1A: 62 sequence variants from 3960 input unique sequences, 1B: 99 from 4877, 2A: 83 from 3652 input, 2B: 131 from 7057, 3A: 124 from 6374, 3B: 100 from 5696. Any sequence that was below 50 reads was discarded because DADA would not be able to assign taxonomy. 
